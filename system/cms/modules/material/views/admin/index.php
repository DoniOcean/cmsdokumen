...
<div id="panel-4" class="panel">
	<div class="panel-hdr">
									...
									<?php echo form_open(base_url().'admin/material/search', 'class="crud"') ?>
									...
									<button type="submit" class="btn btn-primary btn-icon waves-effect waves-themed">
													...
													<a data-toggle="tooltip" title="Reset Search" href="<?php echo base_url()?>admin/material_barang/reset" class="btn btn-default btn-icon waves-effect waves-themed" >
    ...
    <table class="table table-bordered table-striped m-0" cellspacing="0">
		...
		<?php foreach ($materials as $material):?>
			<tr>
			 ...
			 <?php if ( ! in_array($material->material_name, array('user', 'admin'))): ?>
					<a href="<?php echo base_url().'admin/material/delete/'.$material->id?>" class="btn btn-sm btn-icon btn-outline-danger rounded-circle mr-1" title="Delete Record" onclick="return confirm('Do you want to delete this data? ')">
							<i class="fal fa-times"></i>
						</a>
					 	<?php endif ?>
						 <div class="dropdown d-inline-block">
							<a href="<?php echo base_url().'admin/material/edit/'.$material->id?>"   class="btn btn-sm btn-icon btn-outline-primary rounded-circle shadow-0"  aria-expanded="true" title="More options" >
